...
ActiveRecord::Schema.define(:version => 20120224073107) do
  ...
  create_table "accounts", :force => true do |t|
    ...
    t.text     "cf_description"
    t.text     "cf_registration"
    t.string   "cf_edu_type"
  end
  ...
  create_table "contacts", :force => true do |t|
    ...
    t.string   "cf_octopus"
    t.string   "cf_email_subscriptions"
    t.string   "skype",                                         :limit => 128
    t.text     "cf_how_did_you_hear_about_crossroads"
    t.text     "cf_availability"
    t.text     "cf_interested_in_doing"
    t.string   "cf_age"
    t.text     "cf_why_would_you_like_to_volunteer"
    t.text     "cf_other_information"
    t.text     "cf_volunteering_type"
    t.text     "cf_school_or_company"
    t.text     "cf_skills"
    t.text     "cf_languages_spoken"
    t.date     "cf_tour_date"
    t.text     "cf_service_certificates"
    t.date     "cf_seventy_hour_service_certificate"
    t.date     "cf_one_hundred_forty_hour_service_certificate"
    t.string   "cf_resume"
    t.text     "cf_interests"
    t.date     "cf_three_month_review"
    t.date     "cf_trial_period_review"
    t.boolean  "cf_left_the_training_program"
    t.string   "cf_trainee_status"
    t.boolean  "cf_trainee_contract_signed"
    t.string   "cf_volunteer_status"
  end
